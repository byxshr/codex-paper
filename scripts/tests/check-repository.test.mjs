...
test('runtime publication cannot lose rpath inspection, sanitized loader probes, bootstrap imports, or mode attestation', () => withFixture((fixture) => {
  ...
  writeFileSync(runtimePolicy, readFileSync(runtimePolicy, 'utf8')
    ...
    .replaceAll('rewriteLinuxNativeReferences', 'skipLinuxNativeRelocation')
    ...
    .replaceAll('normalizeManagedVenvAliases', 'skipManagedVenvAliasNormalization')
  ...
  assert.match(errors, /locked rollback-safe runtime replacement: rewriteLinuxNativeReferences/)
  ...
  assert.match(errors, /locked rollback-safe runtime replacement: normalizeManagedVenvAliases/)

...
- The exact-count aggregate repository/security suite passed 204/204 and the exact-count study suite passed 87/87 under Node 22.23.1/npm 10.9.8; supply-chain tests passed 18/18 and PDF ingestion security passed 12/12.
